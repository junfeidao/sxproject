...
// yarn add -D chalk compression selfsigned spdy del http-proxy-middleware
...
const args = require(resolve('vue-cli-plugin/loadenv.js'))
const projectOptions = require(resolve('vue.config.js'))
...
const serverOptions = projectOptions.devServer || {}
...
const root = projectOptions.output || resolve('dist')
...
console.log("rootLocation::::", rootLocation, root)
